...
//
// Reads from: ../syllabus-sync/locales/<lang>/translations.json
// Writes to:  lib/app/l10n/app_<lang>.arb

import 'dart:convert';
import 'dart:io';

const webLocalesDir = '../syllabus-sync/locales';
...
void main() async {
  ...
  if (!localesDir.existsSync()) {
    ...
    stderr.writeln('Make sure the web app is at ../syllabus-sync/');
    exit(1);
  }
